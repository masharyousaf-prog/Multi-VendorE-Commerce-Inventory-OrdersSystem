...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Cart>|Cart whereSessionToken($value)
     ...
     * @method static string toSql()
     * @method static string toRawSql()
     * @method static CartItem|null find(int|string $id, string|\Illuminate\Contracts\Database\Query\Expression|(string|\Illuminate\Contracts\Database\Query\Expression)[] $columns)
     * @method static mixed findOr(mixed $id, callable|string|\Illuminate\Contracts\Database\Query\Expression|(string|\Illuminate\Contracts\Database\Query\Expression)[] $columns, callable|null $callback)
     * @method static mixed value(string $column)
     * @method static mixed rawValue()
     * @method static mixed soleValue(string $column)
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property mixed $discount_applied
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<OrderItem>|OrderItem whereDiscountApplied($value)
